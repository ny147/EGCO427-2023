...
// get all contact
app.get("/drugs/", getAllController);
// get one contact
app.get("/drugs/:id", getOneController);

// add one contact
app.post("/drugs", postController);
// edit one contact
app.post("/drugs/:id", editController);

// delete one contact
app.delete("/drugs/:id", deleteController);
